...
<style>
    ...
    /* Modern Reset - MATCHING SERVICE PAGE */
    * {
        margin: 0;
        padding: 0;
        box-sizing: border-box;
    ...
    /* Modern Animations - UPDATED TO MATCH SERVICE PAGE */
    @keyframes fadeInUp {
        from {
            opacity: 0;
    ...
    .hero-title {
        font-size: 3.2rem;
        font-weight: 700; /* Changed from 800 to match service page */
    ...
    .modern-card {
        ...
        border-radius: 15px; /* Changed from 18px to match service page */
        padding: 2.2rem;
        box-shadow: 0 10px 30px rgba(0,0,0,0.05); /* Matched service page shadow */
        transition: all 0.4s ease;
    ...
    .modern-card::before {
        ...
        left: 0;
        width: 100%;
        height: 5px; /* Changed from 3px to match service page */
    ...
    .modern-card:hover {
        transform: translateY(-10px); /* Changed from -8px to match service page */
        box-shadow: 0 15px 35px rgba(0,0,0,0.1); /* Matched service page hover shadow */
    }
    ...
    .card-title {
        font-size: 1.3rem;
        font-weight: 600; /* Changed from 700 to match service page */
    ...
    .asymmetric-title {
        font-size: 2.5rem;
        font-weight: 600; /* Changed from 800 to match service page */
        margin-bottom: 1.3rem;
        color: var(--text-dark);
        line-height: 1.2;
    ...
    .asymmetric-visual {
        ...
        justify-content: center;
        overflow: hidden;
        box-shadow: 0 15px 35px rgba(33, 65, 91, 0.15);
    }
    ...
    .visual-element:hover .visual-image {
    ...
    .image-overlay {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(135deg, rgba(33, 65, 91, 0.7) 0%, rgba(110, 194, 82, 0.3) 100%);
        display: flex;
        align-items: center;
        justify-content: center;
        color: white;
    ...
    .visual-element:hover .image-overlay {
        opacity: 1;
    }
...
<main>
    ...
    <section class="modern-hero">
        ...
        <div class="hero-content">
            <h1 class="hero-title animate-slide-left">
                Insure Tech<br>Services
            </h1>
            <p class="hero-subtitle animate-slide-right">
                Your trusted partner for Life Insurance and General Insurance solutions with IRDAI certification. Premium protection with personalized service.
            </p>
            <div class="hero-stats">
                <div class="hero-stat animate-scale" style="animation-delay: 0.2s">
                    <span class="stat-number" data-count="30">0+</span>
                    <span class="stat-label">Awards Won</span>
                </div>
                <div class="hero-stat animate-scale" style="animation-delay: 0.4s">
                    <span class="stat-number" data-count="15">0L+</span>
                    <span class="stat-label">Happy Clients</span>
                </div>
                <div class="hero-stat animate-scale" style="animation-delay: 0.6s">
    ...
    <section class="modern-grid">
        <div class="modern-card animate-slide-left">
            ...
            <h3 class="card-title">IRDAI Certified</h3>
            <p class="card-description">
                Fully certified insurance advisors providing trusted and reliable insurance solutions with regulatory compliance.
            </p>
        </div>
        
        <div class="modern-card animate-scale">
            <div class="card-icon">
                <i class="fas fa-bolt"></i>
            </div>
            <h3 class="card-title">Quick Claims</h3>
            <p class="card-description">
                Fast and efficient claim processing with 99% success rate and dedicated support for complex cases.
            </p>
        </div>
        ...
        <div class="modern-card animate-slide-right">
            ...
            <h3 class="card-title">15+ Partners</h3>
            <p class="card-description">
                Extensive network with top insurance companies to provide you with the best coverage options.
            </p>
        </div>
    </section>
    ...
    <section class="asymmetric-section">
        <div class="asymmetric-container">
            <div class="asymmetric-content">
                <h2 class="asymmetric-title animate-slide-left">
                    Why Choose<br>Insure Tech?
                </h2>
                <p class="asymmetric-text animate-slide-left" style="animation-delay: 0.2s">
                    We revolutionize insurance services with cutting-edge technology and personalized approach, ensuring you get the perfect coverage.
                </p>
                <ul class="asymmetric-features">
                    <li class="asymmetric-feature animate-scale" style="animation-delay: 0.3s">
                        <div class="feature-icon">
                            <i class="fas fa-car"></i>
                        </div>
                        <span>15+ Motor Insurance Company Tie-ups</span>
                    </li>
                    <li class="asymmetric-feature animate-scale" style="animation-delay: 0.4s">
                        <div class="feature-icon">
                            <i class="fas fa-certificate"></i>
                        </div>
                        <span>IRDAI Certified Insurance Advisor</span>
                    </li>
                    <li class="asymmetric-feature animate-scale" style="animation-delay: 0.5s">
                        <div class="feature-icon">
                            <i class="fas fa-user-tie"></i>
                        </div>
                        <span>Expert Guidance on Policy Selection</span>
                    </li>
                </ul>
            </div>
            <div class="asymmetric-visual animate-slide-right">
                <div class="visual-element">
                    <img src="assets/home1.jpg" alt="Insurance Professionals" class="visual-image">
    ...
    <section class="partners-showcase">
        <h2 class="partners-title animate-scale">Our Insurance Partners</h2>
        <div class="partners-grid">
            <div class="partner-item animate-scale" style="animation-delay: 0.1s">
            <img src="assets/tata.jpeg" class="logo">

                <div class="partner-name">Tata AIG</div>
            </div>
            <div class="partner-item animate-scale" style="animation-delay: 0.2s">
            <img src="assets/chola.png" class="logo">

                <div class="partner-name">Cholamandalam MS</div>
            </div>
            <div class="partner-item animate-scale" style="animation-delay: 0.3s">
                <img src="assets/ergo.png" class="logo">

                <div class="partner-name">HDFC ERGO</div>
            </div>
            <div class="partner-item animate-scale" style="animation-delay: 0.4s">
                            <img src="assets/lombard.png" class="logo">

                <div class="partner-name">ICICI Lombard</div>
            </div>
            <div class="partner-item animate-scale" style="animation-delay: 0.5s">
                            <img src="assets/Bajaj.png" class="logo">

                <div class="partner-name">Bajaj Allianz</div>
            </div>
            <div class="partner-item animate-scale" style="animation-delay: 0.6s">
                            <img src="assets/kotak.jpg" class="logo">

                <div class="partner-name">Kotak Mahindra</div>
            </div>
            <div class="partner-item animate-scale" style="animation-delay: 0.7s">
                            <img src="assets/sbi.png" class="logo">

                <div class="partner-name">SBI General</div>
            </div>
            <div class="partner-item animate-scale" style="animation-delay: 0.8s">
                            <img src="assets/care.png" class="logo">

                <div class="partner-name">Care Insurance</div>
            </div>
        </div>
    </section>
    ...
    <section class="modern-contact">
        <div class="contact-container">
            <div class="contact-info">
                <h2 class="contact-title animate-slide-left">Get In Touch</h2>
                <div class="contact-detail animate-slide-left" style="animation-delay: 0.2s">
                    <div class="contact-icon">
                        <i class="fas fa-building"></i>
                    </div>
                    <div class="contact-text">
                        <strong>Insure Tech Services Pvt Ltd</strong>
                        <span>Selvashakthi Complex, 228/2 Malaipattu Village, Sriperumbudur, Tamil Nadu 601301</span>
                    </div>
                </div>
                <div class="contact-detail animate-slide-left" style="animation-delay: 0.3s">
                    <div class="contact-icon">
                ...
                <div class="contact-detail animate-slide-left" style="animation-delay: 0.4s">
                    <div class="contact-icon">
                        <i class="fas fa-shield-alt"></i>
                    </div>
                    <div class="contact-text">
            ...
            <div class="contact-info">
                <h2 class="contact-title animate-slide-right">Our Specialization</h2>
                <div class="contact-detail animate-slide-right" style="animation-delay: 0.2s">
                    <div class="contact-icon">
                        <i class="fas fa-car"></i>
                    </div>
                    <div class="contact-text">
                        <strong>Motor Insurance</strong>
                        <span>15+ company tie-ups for best premium rates</span>
                    </div>
                </div>
                <div class="contact-detail animate-slide-right" style="animation-delay: 0.3s">
                    <div class="contact-icon">
                        <i class="fas fa-heartbeat"></i>
                    </div>
                    <div class="contact-text">
                        <strong>Life Insurance</strong>
                        <span>Kotak Mahindra, Axis Max Life, HDFC</span>
                    </div>
                </div>
                <div class="contact-detail animate-slide-right" style="animation-delay: 0.4s">
                    <div class="contact-icon">
                        <i class="fas fa-stethoscope"></i>
                    </div>
                    <div class="contact-text">
                        <strong>Health Insurance</strong>
                        <span>Care Insurance, Tata AIG, ICICI</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="cta-section">
        <h2 class="cta-title animate-scale">Ready to Get Protected?</h2>
        <p class="cta-subtitle animate-scale" style="animation-delay: 0.2s">
            Join thousands of satisfied clients who trust us with their insurance needs
        </p>
        <a href="services.php" class="cta-button animate-scale" style="animation-delay: 0.4s">
            Our Services
        </a>
    </section>
</main>

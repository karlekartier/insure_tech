...
export function ClaimToPaymentFlow() {
  ...
  return (
    <div className="w-full glass-panel p-6 sm:p-8 lg:p-10 border border-[var(--border-subtle)] relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 pb-6 border-b border-[var(--border-subtle)]">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-500 mb-2">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Interactive Workflow Explorer</span>
          </div>
          <h3 className="text-2xl sm:text-3xl font-bold text-[var(--text-primary)]">
            End-to-End <span className="text-gradient-emerald">Claim to Payment</span> Architecture
          </h3>
        ...
        <div className="flex items-center gap-4 bg-[var(--bg-surface)] px-4 py-2.5 rounded-xl border border-[var(--border-subtle)] shrink-0 shadow-sm">
          ...
          <div className="text-xs">
            ...
            <span className="text-sm font-bold text-emerald-500">98.2% First-Pass Clean</span>
          </div>
        </div>
      </div>
          ...
          return (
            ...
            >
              <div className={`p-2 rounded-lg mb-1.5 transition-colors ${
                isSelected ? "bg-emerald-500 text-white" : "bg-emerald-500/10 text-emerald-500"
              }`}>
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="bg-[var(--bg-surface)] rounded-2xl p-6 sm:p-8 border border-emerald-500/30 shadow-lg relative"
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="glass-panel p-5 border border-emerald-500/20 space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl text-xs font-semibold text-white bg-gradient-to-r from-emerald-600 to-[#4d915d] hover:brightness-110 transition-all flex items-center justify-center gap-2"
                >

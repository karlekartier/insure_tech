      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-slate-50 border border-slate-200 rounded-3xl p-6 sm:p-8 space-y-6 shadow-sm">
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-[#19375c] mt-1">
                ...
                <div className="space-y-4 text-sm text-slate-600">
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      <h4 className="font-bold text-[#19375c] text-sm">
                        Office Location
                      </h4>
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      ...
                      <a
                        href="tel:9150005721"
                        className="text-xs text-orange-600 hover:underline font-bold mt-0.5 block"
                      >
                        +91 91500 05721
                      </a>
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 mt-0.5 leading-relaxed">
                        ...
                        <span className="text-emerald-600 font-semibold">24/7 Claim Assistance Helpline Active</span>
                      </p>
                    </div>
                  </div>
            ...
            {/* Right Column: Simplified Contact Form (7 cols) */}
      ...
      <section className="py-16 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-xl mx-auto mb-8">
            ...
            <h3 className="text-2xl font-bold text-[#19375c] mt-1">
          ...
          <div className="rounded-3xl overflow-hidden shadow-xl border border-slate-200 h-[380px] w-full relative">
            <iframe
